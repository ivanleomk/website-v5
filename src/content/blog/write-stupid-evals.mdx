...
| Evaluation Type | Complexity | Setup Time | Best For |
| :--- | :--- | :--- | :--- |
| **Simple Assertions** | Low | < 5 mins | Basic formatting, schema validation |
| **LLM-as-a-Judge** | Medium | 1-2 hours | Subjective qualities, tone, relevance |
| **Human-in-the-Loop** | High | Ongoing | Gold standard, final validation |
